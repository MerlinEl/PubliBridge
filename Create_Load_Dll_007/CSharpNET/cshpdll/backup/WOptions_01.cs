...
namespace cshpdll {
    ...
    public class WOptions : IDictionary {
        // The array of items
        private DictionaryEntry[] items;
        private Int32 ItemsInUse = 0;

        // Construct the WOptions with the desired number of items.
        // The number of items cannot change for the life time of this WOptions.
        public WOptions(Int32 numItems) {
        ...
        private class WOptionsEnumerator : IDictionaryEnumerator {
            // A copy of the WOptions object's key/value pairs.
            DictionaryEntry[] items;
            Int32 index = -1;

            public WOptionsEnumerator(WOptions sd) {
                // Make a copy of the dictionary entries currently in the WOptions object.
        ...
        public IDictionaryEnumerator GetEnumerator() {
            ...
            return new WOptionsEnumerator(this);
        }
        #endregion
