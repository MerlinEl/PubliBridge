namespace PeerstPlayer.Controls.WriteField
{
	partial class WriteFieldControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.selectThreadLabel.Text = "Loading...";
			...
			this.toolTip.SetToolTip(this.writeButton, "Write a reply on the bulletin board");
			...
			this.newResToolTip.ToolTipTitle = "New arrival less";
			// 
			// writeFieldTextBox
			// 
			...
			this.writeFieldTextBox.WatermarkText = "Loading...";
