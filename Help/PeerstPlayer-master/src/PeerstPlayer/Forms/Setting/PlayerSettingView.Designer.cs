...
namespace PeerstPlayer.Forms.Setting
{
	partial class PlayerSettingView
	{
		...
		private void InitializeComponent()
		{
			...
			this.settingPage.Text = "Various settings ①";
			...
			this.volumeChangeGroupBox.Text = "Volume change";
			// 
			...
			this.volumeChangeNoneLabel.Text = "Wheel rotation:";
			// 
			...
			this.volumeChangeShiftLabel.Text = "Shift + wheel rotation:";
			// 
			...
			this.volumeChangeCtrlLabel.Text = "Ctrl + wheel rotation:";
			// 
			...
			this.frameInvisibleCheckBox.Text = "Erase the frame (restart required)";
			...
			this.aspectRateFixCheckBox.Text = "Maintain aspect ratio";
			...
			this.windowSnapEnableCheckBox.Text = "Window snap enabled";
			...
			this.initGroupBox.Text = "Early representation";
			// 
			...
			this.returnSizeOnStartCheckBox.Text = "Restore window size";
			...
			this.returnPositionOnStartCheckBox.Text = "Return window position";
			...
			this.initVolumeLabel.Text = "Initial volume:";
			// 
			...
			this.writeFieldVisibleCheckBox.Text = "Writing field display";
			...
			this.topMostCheckBox.Text = "front row representation";
			...
			this.movieStartGroupBox.Text = "When playing a video";
			// 
			// movieStartComboBox
			// 
			...
			this.closeGroupBox.Text = "When finished";
			// 
			...
			this.exitedViewerCloseCheckBox.Text = "Exit Viewer";
			...
			this.saveReturnSizeCheckBox.Text = "Save window size";
			...
			this.saveReturnPositionCheckBox.Text = "Save window position";
			...
			this.disconnectRealyOnCloseCheckBox.Text = "Relay disconnection";
			...
			this.statusBarGroupBox.Text = "Status bar";
			// 
			...
			this.hideStatusBarOnFullscreenCheckBox.Text = "Hide status bar with maximize";
			...
			this.listenerNumberCheckBox.Size = new System.Drawing.Size(95, 16);
			this.listenerNumberCheckBox.TabIndex = 1;
			this.listenerNumberCheckBox.Text = "Display the number of relays";
			...
			this.displayBitrateCheckBox.Text = "Show bit rate";
			...
			this.displayFpsCheckBox.Text = "Show FPS";
			...
			this.settingPage2.Text = "Various settings ②";
			...
			this.browseVlcFolderButton.Text = "Reference";
			...
			this.vlcFolderLabel.Text = "VLC folder";
			...
			this.bufferTimeMaxLabel.Text = "Maximum buffer time (seconds):";
			// 
			...
			this.bufferTimeLabel.Text = "Buffer time (seconds):";
			// 
			// bufferTimeTextBox
			// 
			...
			this.useRtmpCheckBox.Text = "Use RTMP playback";
			...
			this.flvGpuCheckBox.Text = "Use regeneration support";
			...
			this.threadGroupBox.Text = "Thread";
			// 
			...
			this.autoReadThreadCheckBox.Text = "Automatic thread movement (temporary mounting)";
			...
			this.screenshotFormatButton.Text = "Format";
			...
			this.screenshotFormatLabel.Text = "File name";
			// 
			...
			this.screenshotExtensionLabel.Text = "Extension to save";
			// 
			...
			this.browseScreenshotFolderButton.Text = "Reference";
			...
			this.screenshotFolderLabel.Text = "Folder to save";
			// 
			// shortcutPage
			// 
			...
			this.shortcutPage.Text = "Shortcut";
			...
			this.keyLabel.Text = "[Registration method]\r\nShortcut: After selecting a command, key input\r\nMouse gesture: After selecting a command, mouse gesture input\r\n[Delete method]\r\nShortcut: Delete " +
	 "Double-click the shortcut you want to remove (left)\r\nMouse gesture: Double-click the gesture you want to delete (right)";
			// 
			// saveButton
			// 
			...
			this.screenshotContextMenuStrip.Size = new System.Drawing.Size(133, 180);
			// 
			...
			this.year2ToolStripMenuItem.Size = new System.Drawing.Size(132, 22);
			this.year2ToolStripMenuItem.Text = "Year (2 stringers)";
			// 
			// year4ToolStripMenuItem
			// 
			this.year4ToolStripMenuItem.Name = "year4ToolStripMenuItem";
			this.year4ToolStripMenuItem.Size = new System.Drawing.Size(132, 22);
			this.year4ToolStripMenuItem.Text = "Year (4 stringers)";
			// 
			...
			this.hourToolStripMenuItem.Text = "Time";
			// 
			...
			this.channelNameToolStripMenuItem.Text = "Channel name";
			// 
			// shortcutListView
			// 
			...
			// 
			this.shortcutColumnHeader.Text = "Shortcut";
			this.shortcutColumnHeader.Width = 127;
			// 
			// gestureColumnHeader
			// 
			this.gestureColumnHeader.Text = "Mouse gestures";
