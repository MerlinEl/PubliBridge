namespace PeerstPlayer.Forms.ThreadSelect
{
	partial class ThreadSelectView
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBox.Text = "Show stopped threads";
			...
			// 
			this.threadTitleColumnHeader.Text = "Thread title";
			this.threadTitleColumnHeader.Width = 292;
			// 
			// resNumColumnHeader
			// 
			this.resNumColumnHeader.Text = "Number of less";
			this.resNumColumnHeader.Width = 43;
			// 
			// resSpeedColumnHeader
			// 
			this.resSpeedColumnHeader.Text = "Momentum";
			...
			this.Text = "Thread selection screen";
