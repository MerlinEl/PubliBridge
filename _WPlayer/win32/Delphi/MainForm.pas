...
type
  IWPlayer = interface(IInterface)
    ...
    procedure ShowPlayer(); safecall;
    procedure HidePlayer(); safecall;
    procedure LoadFile(fpath: WideString; play: Boolean); safecall;
...
begin
  IfThen(Form1.CbxSwfDirs.Text = 'root', '', Form1.CbxSwfDirs.Text);
end;
...
begin
  ...
  WPlayer.ShowPlayer();
  WPlayer.LoadFile(CbxBookDirs.Text + '\' + getSubdir() + '\' +
    CbxSwfFiles.Text, ChkPlayOnStart.Checked);
end;
