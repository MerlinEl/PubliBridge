...
namespace WalkerPlayerConsole {
    public partial class WPConsoleForm : Form {
        ...
        public WPConsoleForm() => Init();
        public WPConsoleForm(Form parent) => Init(parent);
        public WPConsoleForm(Form parent, bool topMost) => Init(parent, topMost);
        public WPConsoleForm(Form parent, bool topMost, bool inivisible) => Init(parent, topMost, inivisible);
        ...
        private void OnTitleMouseDown(object sender, MouseEventArgs e) {
            ...
            if (e.Button == MouseButtons.Left && e.Clicks == 1) { //single click
                ...
                Message msg =
                    Message.Create(this.Handle, (int)WPUIMsg.WM.NCLBUTTONDOWN,
                        new IntPtr((int)WPUIMsg.HT.CAPTION), IntPtr.Zero);
        ...
        private void OnaboutMcConsoleToolStripMenuItem_Click(object sender, EventArgs e) {
            WPConsoleAboutForm f = new WPConsoleAboutForm {
